export const siteConfig = {
  ...
  whatsapp: {
    ...
    message:
      "Olá! Gostaria de agendar uma consulta com a Dra. Teresa Marly.",
  },
  address: {
    full: "Ed. Manhattan River Center - Avenida Senador Arêa Leão 2185, R. Prof. Elías Tôrres, 1 - Sl 1211, Teresina - PI, 64051-090",
    short: "Manhattan River Center, Teresina - PI",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Ed.+Manhattan+River+Center,+Avenida+Senador+Arêa+Leão+2185,+Teresina+-+PI,+64051-090",
  },
